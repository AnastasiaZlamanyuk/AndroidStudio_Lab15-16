# Student Planner
Мобильное приложение для студентов, позволяющее отслеживать учебные дисциплины, просматривать детальную информацию о каждой дисциплине, управлять профилем и настройками. Приложение демонстрирует принципы навигации в Jetpack Compose с использованием библиотеки Navigation Compose.
## Реализованные экраны
1. **HomeScreen** — отображает список учебных дисциплин в виде карточек
2. **DetailsScreen** — показывает подробную информацию о выбранной дисциплине
3. **ProfileScreen** — отображает информацию о студенте
4. **SettingsScreen** — позволяет настраивать параметры приложения
...
```
Home (Главный экран)
├── Details (при клике на карточку дисциплины)
│ └── Home (назад через системную кнопку или кнопку в TopAppBar)
...
![1](app/img/step7_navigation_working_Zlamanyuk_1.png)
![2](app/img/step7_navigation_working_Zlamanyuk_2.png)
![3](app/img/step7_navigation_working_Zlamanyuk_3.png)
![4](app/img/step7_navigation_working_Zlamanyuk_4.png)
